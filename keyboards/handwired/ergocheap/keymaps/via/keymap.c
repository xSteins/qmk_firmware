...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FN1] = LAYOUT(
        ...
        KC_LCTL, KC_LEFT, _______, _______, _______, _______,   _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, KC_LEFT,   KC_RIGHT,    _______, _______,
        KC_LSFT, _______, KC_UP,   KC_DOWN, KC_RGHT, _______,   _______, KC_VOLD, KC_MUTE, KC_VOLU, KC_DOWN, KC_RSHIFT, KC_MS_WH_UP, _______,
        _______, _______, _______, _______, _______,            _______, _______, _______, _______, _______, KC_MS_WH_LEFT, KC_MS_WH_DOWN, KC_MS_WH_RIGHT,
